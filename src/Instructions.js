  ...
  render(){
    return(
      <div onClick={this.hideInstructions}>
        ...
        <p style={textStyle}>See that blue dot? That's you. Any red dots you might see are other users.</p>
        ...
        <p style={textStyle}>The x axis controls the note, the y axis controls the tone, and the z axis controls where in the sequence your note is played.</p>
